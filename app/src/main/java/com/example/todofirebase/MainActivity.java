...
import com.example.todofirebase.adapter.TarefaAdpter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextNomeTarefa = findViewById(R.id.edit_text);
    ...
    //Leitura do banco para o listview
    private void eventoBanco(){
        ...
        databaseReference.child("tarefa").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                arrayAdapterTarefa = new TarefaAdpter(MainActivity.this,
